...
STRINGS: dict[str, str] = {
    ...
    "transcription.backend.hint.gemini": "高精度、カスタム語彙対応、無料枠あり",
    ...
    "transcription.keys.gemini.label": "Geminiキー",
    "transcription.keys.gemini.placeholder": "Gemini APIキーを入力",
    "transcription.keys.gemini.nudge": "← Geminiキーを入力",
    "transcription.keys.gemini.help.title": "Gemini APIキーの取得方法(無料)",
    "transcription.keys.gemini.help.step1": "1. aistudio.google.com にサインイン",
    "transcription.keys.gemini.help.step2": "2.「Get API key」→「Create API key」",
    "transcription.keys.gemini.help.step3": "3. コピーしてここに貼り付け",
    "transcription.keys.gemini.help.link": "Google AI Studioを開く",
