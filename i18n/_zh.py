...
STRINGS: dict[str, str] = {
    ...
    "transcription.backend.hint.gemini": "准确，支持自定义词汇，有免费额度",
    ...
    "transcription.keys.gemini.label": "Gemini 密钥",
    "transcription.keys.gemini.placeholder": "输入 Gemini API 密钥",
    "transcription.keys.gemini.nudge": "← 输入你的 Gemini 密钥",
    "transcription.keys.gemini.help.title": "如何获取 Gemini API 密钥（免费）",
    "transcription.keys.gemini.help.step1": "1. 登录 aistudio.google.com",
    "transcription.keys.gemini.help.step2": "2. 「Get API key」→「Create API key」",
    "transcription.keys.gemini.help.step3": "3. 复制它并粘贴到这里",
    "transcription.keys.gemini.help.link": "打开 Google AI Studio",
