...
STRINGS: dict[str, str] = {
    ...
    "languages.ai.title": "Procesamiento de texto con IA",
    "languages.ai.hint": "Se aplica a traducir, corregir y reescribir — tanto los botones de la ventana como las acciones de atajo.",
    "languages.ai.max_tokens.label": "Longitud máx. de respuesta",
    "languages.ai.max_tokens.hint": "Límite superior de una respuesta de la IA, en tokens (unos 3–4 caracteres cada uno). Auméntalo si los textos largos llegan cortados — solo se facturan los tokens realmente generados.",
    ...
    "transcription.backend.name.gemini": "Gemini",
    ...
    "transcription.backend.hint.gemini": "preciso, vocabulario personalizado, nivel gratuito",
    ...
    "transcription.keys.gemini.label": "Clave de Gemini",
    "transcription.keys.gemini.placeholder": "Introduzca la clave API de Gemini",
    "transcription.keys.gemini.nudge": "← Introduzca su clave de Gemini",
    "transcription.keys.gemini.help.title": "Cómo obtener una clave API de Gemini (gratis)",
    "transcription.keys.gemini.help.step1": "1. Inicie sesión en aistudio.google.com",
    "transcription.keys.gemini.help.step2": "2. «Get API key» → «Create API key»",
    "transcription.keys.gemini.help.step3": "3. Cópiela y péguela aquí",
    "transcription.keys.gemini.help.link": "Abrir Google AI Studio",
    ...
    "transcription.mic.title": "Micrófono",
    "transcription.mic.hint": (
        "Qué entrada se graba y una preparación ligera del audio antes de la "
        "transcripción (filtro paso alto y normalización de nivel). No cambia el modelo ASR."
    ),
    "transcription.mic.device.label": "Dispositivo de entrada",
    "transcription.mic.device.hint": (
        "El predeterminado del sistema sigue a Windows. Elija un micrófono "
        "concreto si captura el dispositivo equivocado o usa un micrófono USB de escritorio."
    ),
    "transcription.mic.device.default": "Predeterminado del sistema",
    "transcription.enhance.label": "Mejora de audio",
    "transcription.enhance.hint": (
        "Ligera: sube un poco el habla baja y reduce el zumbido grave antes de "
        "enviarlo al modelo. Desactivada: captura en bruto (comportamiento anterior)."
    ),
    "transcription.enhance.off": "Desactivada",
    "transcription.enhance.light": "Ligera (recomendada)",
    ...
    "main.tooltip.add_term": "Añadir un término para la transcripción",
    ...
    "main.glossary_pro.title": "Los términos de transcripción son una función Pro",
    "main.glossary_pro.body": "Pro abre la lista de términos desde aquí y la amplía a 200, más paquetes profesionales listos. El plan gratuito incluye 5 términos: añádalos en Ajustes → Glosario.",
