...
STRINGS: dict[str, str] = {
    ...
    "transcription.backend.hint.gemini": "accurate, custom vocabulary, free tier",
    ...
    "transcription.keys.gemini.label": "Gemini key",
    "transcription.keys.gemini.placeholder": "Enter Gemini API key",
    "transcription.keys.gemini.nudge": "← Enter your Gemini key",
    "transcription.keys.gemini.help.title": "Getting a Gemini API key (free)",
    "transcription.keys.gemini.help.step1": "1. Sign in at aistudio.google.com",
    "transcription.keys.gemini.help.step2": "2. Get API key → Create API key",
    "transcription.keys.gemini.help.step3": "3. Copy it and paste it here",
    "transcription.keys.gemini.help.link": "Open Google AI Studio",
