...
STRINGS: dict[str, str] = {
    ...
    "transcription.backend.hint.gemini": "preciso, vocabolario personalizzato, piano gratuito",
    ...
    "transcription.keys.gemini.label": "Chiave Gemini",
    "transcription.keys.gemini.placeholder": "Inserisci la chiave API Gemini",
    "transcription.keys.gemini.nudge": "← Inserisci la tua chiave Gemini",
    "transcription.keys.gemini.help.title": "Come ottenere una chiave API Gemini (gratuita)",
    "transcription.keys.gemini.help.step1": "1. Accedi su aistudio.google.com",
    "transcription.keys.gemini.help.step2": "2. «Get API key» → «Create API key»",
    "transcription.keys.gemini.help.step3": "3. Copiala e incollala qui",
    "transcription.keys.gemini.help.link": "Apri Google AI Studio",
    ...
    # Avvisi di errore dell'API cloud (services/api_errors.py). Mostrati come
    # notifica di Windows dentro una cornice vistosa «!!! ⚠ … ⚠ !!!» perché non
    # possano mai passare per testo dettato.
    "error.transcribe.title": "Il parlato non è stato trascritto",
    "error.postprocess.title": "Testo incollato senza correzione",
    "error.api.quota": "{provider}: crediti API esauriti — controlla il saldo dell'account",
    "error.api.auth": "{provider}: chiave API rifiutata — controllala nelle impostazioni",
    "error.api.rate": "{provider}: limite di richieste raggiunto — riprova tra un minuto",
    "error.api.network": "{provider}: nessuna connessione — controlla la rete",
    "error.api.unknown": "{provider}: errore imprevisto — vedi il log",
    ...
    "main.tooltip.add_term": "Aggiungi un termine per la trascrizione",
    ...
    "main.glossary_pro.title": "I termini di trascrizione sono una funzione Pro",
    "main.glossary_pro.body": "Pro apre l'elenco dei termini da qui e lo porta a 200, più pacchetti professionali pronti. Il piano gratuito include 5 termini: aggiungili in Impostazioni → Glossario.",
