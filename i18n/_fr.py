...
STRINGS: dict[str, str] = {
    ...
    "languages.ai.title": "Traitement de texte par IA",
    "languages.ai.hint": "S'applique à la traduction, la correction et la réécriture — boutons de la fenêtre comme actions par raccourci.",
    "languages.ai.max_tokens.label": "Longueur max. de réponse",
    "languages.ai.max_tokens.hint": "Limite supérieure d'une réponse de l'IA, en tokens (environ 3–4 caractères chacun). Augmentez-la si les textes longs arrivent tronqués — seuls les tokens réellement générés sont facturés.",
    ...
    "transcription.backend.hint.gemini": "précis, vocabulaire personnalisé, offre gratuite",
    ...
    "transcription.keys.gemini.label": "Clé Gemini",
    "transcription.keys.gemini.placeholder": "Saisissez la clé API Gemini",
    "transcription.keys.gemini.nudge": "← Saisissez votre clé Gemini",
    "transcription.keys.gemini.help.title": "Obtenir une clé API Gemini (gratuit)",
    "transcription.keys.gemini.help.step1": "1. Connectez-vous sur aistudio.google.com",
    "transcription.keys.gemini.help.step2": "2. « Get API key » → « Create API key »",
    "transcription.keys.gemini.help.step3": "3. Copiez-la et collez-la ici",
    "transcription.keys.gemini.help.link": "Ouvrir Google AI Studio",
    ...
    "transcription.mic.hint": (
        "Quelle entrée est enregistrée et une légère préparation audio avant "
        "la transcription (filtre passe-haut et normalisation du niveau). "
        "Ne change pas le modèle ASR."
    ),
    "transcription.mic.device.label": "Périphérique d'entrée",
    "transcription.mic.device.hint": (
        "Le défaut système suit Windows. Choisissez un micro précis si le "
        "mauvais périphérique capture, ou si vous utilisez un micro USB de bureau."
    ),
    "transcription.mic.device.default": "Défaut système",
    "transcription.enhance.label": "Amélioration audio",
    "transcription.enhance.hint": (
        "Légère : renforce un peu la parole faible et coupe le ronflement grave "
        "avant l'envoi au modèle. Désactivée : capture brute (comportement précédent)."
    ),
    "transcription.enhance.off": "Désactivée",
    "transcription.enhance.light": "Légère (recommandée)",
    ...
    "main.tooltip.add_term": "Ajouter un terme pour la transcription",
    ...
    "main.glossary_pro.title": "Les termes de transcription sont une fonction Pro",
    "main.glossary_pro.body": "Pro ouvre la liste des termes depuis ici et la porte à 200, plus des packs métiers prêts à l'emploi. L'offre gratuite comprend 5 termes — ajoutez-les dans Paramètres → Glossaire.",
